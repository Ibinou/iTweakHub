function afficherDonnees() {
    ...
    function afficherSourcesModale(dataArray) {
        ...
        dataArray.forEach(function(data, index) {
            if (data && data.iconURL && data.name && data.sourceURL) {
                ...
                sourceItemDiv.setAttribute("data-json-url", data.sourceURL);
                ...
                sourceLink.href = 'repoview.html?repo=' + encodeURIComponent(data.sourceURL);
